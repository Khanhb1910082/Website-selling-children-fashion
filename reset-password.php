...
{
    $error_message2 = 'Thời gian email đặt lại mật khẩu (24 giờ) đã hết hạn. Vui lòng thử đặt lại mật khẩu của bạn một lần nữa';
}
...
if(isset($_POST['form1'])) {
    ...
    {
        $valid = 0;
        $error_message = 'Nhập vào mật khẩu mới\\n';
    }
    else
    {
        ...
        {
            $valid = 0;
            $error_message = 'Mật khẩu không hợp lệ\\n';
        }
    }   
                        ...
                        <form action="" method="post">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <div class="form-group">
                                        <label for=""></label>
                                        <input type="submit" class="btn btn-primary" value="Xác nhận" name="form1">
                                    </div>
                                </div>
                            </div>                        
                        </form>
