...
if(isset($_POST['form_contact']))
{
    ...
    {
        $valid = 0;
        $error_message .= 'Xin vui lòng điền tên của bạn.\n';
    }
    ...
    {
        $valid = 0;
        $error_message .= 'Hãy điền Email của bạn.\n';
    }
    else
    {
        // Email check
...
?>
                ...
                ?>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="cust_address" placeholder="Nhập địa chỉ">
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                    ...
                    <div class="col-md-4">
                        <legend><span class="glyphicon glyphicon-globe"></span> Turtle-K Shop</legend>
                        <address>
