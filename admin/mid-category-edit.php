...
if(isset($_POST['form1'])) {
    ...
    if(empty($_POST['mcat_name'])) {
        $valid = 0;
        $error_message .= "Nhập tên danh mục phân cấp.<br>";
    }
    ...
    if($valid == 1) {    	
    	...
    	$success_message = 'Danh mục phân cấp được cập nhật thành công.';
    }
}
?>
...
<section class="content-header">
	<div class="content-header-left">
		<h1>Edit danh mục phân cấp</h1>
	</div>
	<div class="content-header-right">
		<a href="mid-category.php" class="btn btn-primary btn-sm">Xem lại</a>
	</div>
</section>
    ...
    <div class="col-md-12">
        ...
        <div class="box box-info">
            ...
            <div class="box-body">
                ...
                <div class="form-group">
                    <label for="" class="col-sm-3 control-label">Tên danh mục phân cấp <span>*</span></label>
                    <div class="col-sm-4">
