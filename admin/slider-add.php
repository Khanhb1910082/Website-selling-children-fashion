...
if(isset($_POST['form1'])) {
    ...
    if($path!='') {
        ...
        if( $ext!='jpg' && $ext!='png' && $ext!='jpeg' && $ext!='gif' ) {
            $valid = 0;
            $error_message .= 'File ảnh thuộc định dạng jpg, jpeg, gif or png.<br>';
        }
    } else {
    	$valid = 0;
        $error_message .= 'Vui lòng chọn 1 ảnh<br>';
    }
...
<section class="content-header">
	...
	<div class="content-header-right">
		<a href="slider.php" class="btn btn-primary btn-sm">Xem lại</a>
	</div>
</section>
					...
					<div class="box-body">
						<div class="form-group">
							...
							<div class="col-sm-9" style="padding-top:5px">
								<input type="file" name="photo">(File ảnh thuộc định dạng jpg, jpeg, gif and png.)
							</div>
						</div>
						<div class="form-group">
						...
						<div class="form-group">
							<label for="" class="col-sm-2 control-label">Button </label>
							<div class="col-sm-6">
