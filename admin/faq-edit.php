...
if(isset($_POST['form1'])) {
	...
	if(empty($_POST['faq_title'])) {
		$valid = 0;
		$error_message .= 'Chưa nhập tiêu đề<br>';
	}

	if(empty($_POST['faq_content'])) {
		$valid = 0;
		$error_message .= 'Chưa nhập nội dung<br>';
	}
	...
	if($valid == 1) {
	    ...
	    $success_message = 'FAQ cập nhật thành công!';
	}
}
?>
...
<section class="content-header">
	...
	<div class="content-header-right">
		<a href="faq.php" class="btn btn-primary btn-sm">Xem lại</a>
	</div>
</section>
