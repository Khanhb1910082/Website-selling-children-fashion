...
if(isset($_POST['form1'])) {
    ...
    if(empty($_POST['email']) || empty($_POST['password'])) {
        $error_message = 'Email và mật khẩu không được bỏ trống.<br>';
    } else {
...
<div class="login-box">
	<div class="login-logo">
		<b>Quản trị Turtle-K Shop</b>
	</div>
  	<div class="login-box-body">
    	<p class="login-box-msg">Đăng nhập với tư cách quản trị.</p>
