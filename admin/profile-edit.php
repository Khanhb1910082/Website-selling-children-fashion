...
if(isset($_POST['form1'])) {
	...
	if($_SESSION['user']['role'] == 'Super Admin') {
	    ...
	    if(empty($_POST['full_name'])) {
	        $valid = 0;
	        $error_message .= "Tên không được bỏ trống.<br>";
	    }

	    if(empty($_POST['email'])) {
	        $valid = 0;
	        $error_message .= 'Email không được bỏ trống.<br>';
	    } else {
...
if(isset($_POST['form3'])) {
	...
	if( empty($_POST['password']) || empty($_POST['re_password']) ) {
        $valid = 0;
        $error_message .= "Mật khẩu không được bỏ trống.<br>";
    }
		...
		<div class="col-md-12">
				...
				<div class="nav-tabs-custom">
					<ul class="nav nav-tabs">
						...
						<li><a href="#tab_2" data-toggle="tab">Ảnh đại diện</a></li>
