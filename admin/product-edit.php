...
if(isset($_POST['form1'])) {
    ...
    if(empty($_POST['tcat_id'])) {
        $valid = 0;
        $error_message .= "Chọn danh mục tổng thể<br>";
    }

    if(empty($_POST['mcat_id'])) {
        $valid = 0;
        $error_message .= "Chọn danh mục phân cấp<br>";
    }

    if(empty($_POST['ecat_id'])) {
        $valid = 0;
        $error_message .= "Chọn danh mục chi tiết<br>";
    }

    if(empty($_POST['p_name'])) {
        $valid = 0;
        $error_message .= "Nhập tên sản phẩm<br>";
    }

    if(empty($_POST['p_current_price'])) {
        $valid = 0;
        $error_message .= "Nhập giá sản phẩm<br>";
    }

    if(empty($_POST['p_qty'])) {
        $valid = 0;
        $error_message .= "Nhập số lượng sản phẩm<br>";
    }
...
<section class="content-header">
	...
	<div class="content-header-right">
		<a href="product.php" class="btn btn-primary btn-sm">Xem lại</a>
	</div>
</section>
				...
				<div class="box box-info">
					<div class="box-body">
						<div class="form-group">
							<label for="" class="col-sm-3 control-label">Danh mục tổng thể <span>*</span></label>
							<div class="col-sm-4">
								<select name="tcat_id" class="form-control select2 top-cat">
		                            <option value="">Chọn danh mục tổng thể</option>
		                            <?php
						...
						<div class="form-group">
							<label for="" class="col-sm-3 control-label">Danh mục phân cấp <span>*</span></label>
							<div class="col-sm-4">
								<select name="mcat_id" class="form-control select2 mid-cat">
		                            <option value="">Chọn danh mục phân cấp</option>
		                            <?php
						...
						<div class="form-group">
							<label for="" class="col-sm-3 control-label">Danh mục chi tiết <span>*</span></label>
							<div class="col-sm-4">
						...
						<div class="form-group">
							<label for="" class="col-sm-3 control-label">Giá<br><span style="font-size:10px;font-weight:normal;">(VNĐ)</span></label>
							<div class="col-sm-4">
								<input type="text" name="p_old_price" class="form-control" value="<?php echo $p_old_price; ?>">
							</div>
						</div>	
						<div class="form-group">
							<label for="" class="col-sm-3 control-label">Giá khuyến mãi <span>*</span><br><span style="font-size:10px;font-weight:normal;">(VNĐ)</span></label>
							<div class="col-sm-4">
						...
						<div class="form-group">
							<label for="" class="col-sm-3 control-label">Ảnh sản phẩm</label>
						...
						<div class="form-group">
							<label for="" class="col-sm-3 control-label">Thay đổi ảnh </label>
							<div class="col-sm-4" style="padding-top:4px;">
						...
						<div class="form-group">
							<label for="" class="col-sm-3 control-label">Bảo quản</label>
							<div class="col-sm-8">
						...
						<div class="form-group">
							<label for="" class="col-sm-3 control-label">Bày bán</label>
							<div class="col-sm-8">
