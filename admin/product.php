				...
				<div class="box-body table-responsive">
					...
					<thead class="thead-dark">
							<tr>
								...
								<th width="60">Giá</th>
								<th width="100">Giá khuyễn mãi</th>
								<th width="60">Số lượng</th>
								<th>Nổi bật</th>
								<th>Bày bán</th>
								<th>Loại</th>
								<th width="80">Thiết lập</th>
							</tr>
						</thead>
						<tbody>
							<?php
							...
							foreach ($result as $row) {
								...
								<tr>
									...
									<td><?php echo number_format($row['p_old_price'],0,',','.'); ?>đ</td>
									<td><?php echo number_format($row['p_current_price'],0,',','.'); ?>đ</td>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <p>Bạn có chắc muốn xóa sản phầm này?</p>
                <p style="color:red;">Hãy cẩn thận! Sản phẩm này sẽ bị xóa khỏi bảng đặt hàng, bảng thanh toán, bảng size, bảng màu và cả bảng đánh giá.</p>
            </div>
