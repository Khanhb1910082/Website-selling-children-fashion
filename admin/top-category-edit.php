...
if(isset($_POST['form1'])) {
    ...
    if(empty($_POST['tcat_name'])) {
        $valid = 0;
        $error_message .= "Tên danh mục không thể trống<br>";
    } else {
		// Kiểm tra danh mục hàng đầu trùng lặp
        // tên Top Category hiện tại trong cơ sở dữ liệu
...
<section class="content-header">
	<div class="content-header-left">
		<h1>Edit danh mục tổng thể</h1>
	</div>
	<div class="content-header-right">
		<a href="top-category.php" class="btn btn-primary btn-sm">Xem lại</a>
	</div>
</section>
        ...
        <div class="box box-info">
            ...
            <div class="box-body">
                <div class="form-group">
                    <label for="" class="col-sm-2 control-label">Danh mục tổng thể <span>*</span></label>
                    <div class="col-sm-4">
                        <input type="text" class="form-control" name="tcat_name" value="<?php echo $tcat_name; ?>">
                    </div>
                </div>
                <div class="form-group">
                    <label for="" class="col-sm-2 control-label">Hiện menu? <span>*</span></label>
                    <div class="col-sm-4">
